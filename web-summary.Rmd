...
Resulting trajectories from all scenarios.
...
```{r cumsumsl,  fig.cap='Summary of model projections for different scenarios for six weeks from today.'}
...
```{r scen1l}
knitr::include_graphics(here("output/figures",'increased-sd-traj-log.png'))
```


```{r scen2l}
knitr::include_graphics(here("output/figures",'status-quo-traj-log.png'))
```


```{r scen3l}
knitr::include_graphics(here("output/figures",'relax-sd-traj-log.png'))
```


```{r scen4l}
knitr::include_graphics(here("output/figures",'return-normal-traj-log.png'))
```


```{r scen5l}
knitr::include_graphics(here("output/figures",'no-intervention-traj-log.png'))
```
