...
5. **Best social distancing to date.** Social distancing remains at the lowest observed level to date. 
...
The following plot shows the range (80% coverage of simulations) of projected cumulative number of recorded cases, hospitalizations, and deaths six weeks from today for each scenario.
...
```{r scen5}
knitr::include_graphics(here("output/figures",'lowest-sd-traj.png'))
```
...
```{r scen5l}
knitr::include_graphics(here("output/figures",'lowest-sd-traj-log.png'))
```
