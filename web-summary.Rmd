...
* $\boldsymbol{S}$ - Uninfected and *susceptible* individuals. Susceptible individuals can become infected by individuals in the $E$, $I_a$, $I_su$, $I_sd$, $C$, and $H$ stages. Rates of transmission from these stages can be adjusted individually.
