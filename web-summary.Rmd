...
To better understand the potential range of epidemic outcomes in the state of Georgia, we developed a model based on the accumulation of knowledge from various locations and calibrated to regionally specific conditions in Georgia and observations of the number of reported cases, hospitalizations, and deaths.
This model supercedes prior models published on this website.
...
1. **Increased social distancing.** Social distancing reduces movements from the current level to ????, which is the reduction observed in New York City that enabled transmission to decline there.
...
This model comprises susceptible, pre-symptomatic, asymptomatic, symptomatic, diagnosed, hopspitalized, dead and recovered persons. 
...
* **E** - Individuals who hae been *exposed*, and so are infected, but do not yet show symptoms. Those individuals can be infectious. At the end of the $E$ stage, a fraction moves into the $I_a$ stage, another fraction moves into the $I_{su}$ stage, and the remainder into the $I_{sd}$ stage.
...
* **H** - Individuals who have been *hospitalized*. Those individuals are likely isolated and not infectious, but the model allows to adjust this. A fraction of individuals in the $H$ stage will recover, the remainder dies.
