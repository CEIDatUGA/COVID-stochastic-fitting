...
for(i in 1:length(all_files)) {
  ...
  state_beta_s <- (state_initR0*.1)/state_pop
...
params_vec <- c(MIF_ID = "MIF id", 
                ...
                t_half_detect = "Time at which infection detection fraction is at 50% of max (days since t = 1)",
                base_detect_frac = "Minimum fraction detected at t = 1",
                frac_asym = "Fraction of latent infections that move to aysmptomatic",
