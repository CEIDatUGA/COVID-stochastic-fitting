...
paramfiles_natural <- list.files(path = here('output/current'), "parameter-estimates")
...
# Landing Page figure
# select a few states
selectstates <- c('Georgia', 'Washington', 'North Dakota', 'South Dakota')
dailycases_subset <- dailycases %>%
