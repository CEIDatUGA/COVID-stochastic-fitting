...
The parameters which are estimated can be adjusted in the master script.
...
knitr::kable(table2a, caption = 'LL and parameters transformed to meaningful units.')
```
...
We can also look at scenarios.


```{r scen-plot,  fig.cap=''}
knitr::include_graphics(here('output/figures/scenario-sims.png'))
```
