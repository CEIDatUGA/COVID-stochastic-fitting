...
#' is simulated as a stochastic model using the pomp simulate function
...
#' @param gamma_u : pre-intervention rate at which host goes through I stage, inverse is time to diagnosis : numeric
#' @param gamma_d : post-intervention rate at which host goes through I stage, inverse is time to diagnosis : numeric
