...
/* Time: 2022-04-22 11:19:37.072 -0600 */
/* Salt: E62FE769F214FB84CC1BC0DD */
...
#define b19		(__p[__parindex[45]])
#define b20		(__p[__parindex[46]])
#define b21		(__p[__parindex[47]])
#define b22		(__p[__parindex[48]])
#define b23		(__p[__parindex[49]])
#define b24		(__p[__parindex[50]])
#define b25		(__p[__parindex[51]])
#define b26		(__p[__parindex[52]])
#define b27		(__p[__parindex[53]])
#define b28		(__p[__parindex[54]])
#define b29		(__p[__parindex[55]])
#define b30		(__p[__parindex[56]])
#define b31		(__p[__parindex[57]])
#define b32		(__p[__parindex[58]])
#define b33		(__p[__parindex[59]])
#define b34		(__p[__parindex[60]])
#define b35		(__p[__parindex[61]])
#define b36		(__p[__parindex[62]])
#define b37		(__p[__parindex[63]])
#define S_0		(__p[__parindex[64]])
#define E1_0		(__p[__parindex[65]])
#define Ia1_0		(__p[__parindex[66]])
#define Isu1_0		(__p[__parindex[67]])
#define Isd1_0		(__p[__parindex[68]])
#define C1_0		(__p[__parindex[69]])
#define H1_0		(__p[__parindex[70]])
#define R_0		(__p[__parindex[71]])
#define D_0		(__p[__parindex[72]])
#define trendO_0		(__p[__parindex[73]])
...
#define seas_19		(__covars[__covindex[21]])
#define seas_20		(__covars[__covindex[22]])
#define seas_21		(__covars[__covindex[23]])
#define seas_22		(__covars[__covindex[24]])
#define seas_23		(__covars[__covindex[25]])
#define seas_24		(__covars[__covindex[26]])
#define seas_25		(__covars[__covindex[27]])
#define seas_26		(__covars[__covindex[28]])
#define seas_27		(__covars[__covindex[29]])
#define seas_28		(__covars[__covindex[30]])
#define seas_29		(__covars[__covindex[31]])
#define seas_30		(__covars[__covindex[32]])
#define seas_31		(__covars[__covindex[33]])
#define seas_32		(__covars[__covindex[34]])
#define seas_33		(__covars[__covindex[35]])
#define seas_34		(__covars[__covindex[36]])
#define seas_35		(__covars[__covindex[37]])
#define seas_36		(__covars[__covindex[38]])
#define seas_37		(__covars[__covindex[39]])
